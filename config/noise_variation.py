...
parser.add_argument('-r',
                    '--retail',
                    default = 0.3,
                    help='Proportion of retail traders')
...
if int(args.noise) == 100:
    ...
    mm = 1
    hbl = int((1-int(args.retail)) * (total_agents - noise - mm))
...
# 4) Heuristic Belief Learning Agents    - smarter, represent institutions
if hbl != 0: 
    num_hbl_agents = hbl
